...
const products = [
    {
        ...
        image: '/images/3d-printing-packagefor-po-devices/Image-1.png', // Reusing placeholder for now
        imageLeft: true,
        features: [
    ...
    },
    {
        ...
        image: '/images/3d-printing-packagefor-po-devices/Image-2.png', // Reusing placeholder
        imageLeft: false,
        features: [
            '3D Scan human body parts with Eye-safe & Human skin friendly Hybrid LED & Infrared Light Source Handheld Color 3D Scanner.',
            'The built-in color camera supports capturing full-color texture and skin tone.',
