...
const Hero = () => {
    return (
        <section
            ...
            style={{
                backgroundImage:
                    "url('/images/regraft-bonerip-coloured-3d-printed-material-training-models/hero-bg.png')",
            }}
        >
            <div className="mx-auto max-w-[1367px] px-4 py-20">
                <div className="flex flex-col md:flex-row md:items-start md:gap-6 lg:gap-8">
                    <div className="flex flex-col items-center text-center text-black md:basis-[47.949%] md:items-start md:pt-[137px] md:pl-[101px] md:text-left">
                        <Image
                            src="/images/regraft-bonerip-coloured-3d-printed-material-training-models/regraft-logo.png"
                            alt="ReGraft Logo"
                            width={350}
                            height={140}
                        ...
                        <div className="mt-8 flex flex-col gap-4">
                            <div className="flex items-center gap-4">
                                <Image
                                    src="/images/regraft-bonerip-coloured-3d-printed-material-training-models/phone-icon.png"
                                    alt="Phone"
                                    width={48}
                                    height={48}
                            ...
                            <div className="flex items-center gap-4">
                                <Image
                                    src="/images/regraft-bonerip-coloured-3d-printed-material-training-models/mail-icon.png"
                                    alt="Email"
                                    width={48}
                                    height={48}
                                    className="object-contain"
