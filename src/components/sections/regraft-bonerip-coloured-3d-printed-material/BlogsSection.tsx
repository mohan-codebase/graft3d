        ...
        <div className="bg-white shadow-[2px_0_6px_rgba(0,0,0,0.16)]">
          <div className="grid grid-cols-1 md:grid-cols-3">
            <div className="pt-[15px] pl-[15px] pr-0 pb-0">
              <Link href="/artificial-nasal-prosthesis-case-study/">
                <div className="relative h-[240px] w-full">
                  <Image
                    src="/images/regraft-bonerip-coloured-3d-printed-material-training-models/WhatsApp-Image-2022-07-27-at-11.16.47-AM-2.jpeg"
            ...
            <div className="pt-[15px] pr-[15px] pl-0 pb-0">
              <div className="relative h-[240px] w-full">
                <Image
                  src="/images/regraft-bonerip-coloured-3d-printed-material-training-models/caseStudy2.png"
                  alt="Case Study"
                  fill
                  className="object-fill"
                />
        ...
        <div className="bg-white shadow-[2px_3px_6px_rgba(0,0,0,0.16)] mt-6">
          <div className="grid grid-cols-1 md:grid-cols-3">
            ...
            <div className="pt-0 pb-[15px] px-0">
              <div className="relative h-[240px] w-full">
                <Image
                  src="/images/regraft-bonerip-coloured-3d-printed-material-training-models/case-study.png"
