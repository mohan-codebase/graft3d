                ...
                <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
                    ...
                    <div className="flex flex-col space-y-6 lg:order-1 order-2">
                        <h2 className="text-3xl font-bold text-[#005696] md:text-4xl leading-tight">
                            Regraft RR-MM - Reconstruction of Resected Maxilla & Mandible
                        </h2>

                        <p className="text-lg leading-relaxed text-gray-700">
                            Regraft transforms maxillomandibular reconstruction through 3D-printed patient-specific implants (PSIs). Digital planning and biomechanical optimization ensure accurate occlusion, structural stability, and long-term functional success in complex resections.
                        </p>

                        <div className="pt-4">
                            <Link
                                href="/reconstruction-of-resected-mandible-and-maxilla"
                    ...
                    <div className="relative flex justify-center lg:justify-end lg:order-2 order-1">
                        <div className="relative aspect-video w-full max-w-[550px] rounded-2xl overflow-hidden shadow-lg bg-white border border-gray-100 p-6">
                            <div className="relative w-full h-full">
                                <Image
                                    src="/images/regraft-artibone/arti-5.png"
                                    alt="Regraft RR-MM"
                                    fill
