    ...
    <section className="w-full bg-[#166AAF]">
      <div className="max-w-[1367px] mx-auto px-4 py-[60px] lg:px-[150px] text-center text-white">
        ...
        <p className="mt-4 text-[18px] leading-7">
          ReGraft Bonerip is a patient-specific 3D Printed standard Anatomical training model designed to provide
          ...
          or a student just starting out, with ReGraft Bonerip, you can practice complex surgical procedures in
